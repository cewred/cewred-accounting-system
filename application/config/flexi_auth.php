...
*/
	...
	*/ 
	...
	$config['database']['user_acc']['columns']['nip'] = 'uacc_nip';
	$config['database']['user_acc']['columns']['nip_bpk'] = 'uacc_nip_bpk';
	...
	*/ 
	$config['database']['settings']['primary_identity_col'] = 'uacc_nip_bpk';  
	...
	*/ 
	$config['database']['settings']['identity_cols'] = array('uacc_nip', 'uacc_nip_bpk');
	...
	*/
	...
	$config['sessions']['first_name'] = 'first_name';
	...
	*/
	...
	$config['email']['reply_email'] = "info@labdvisor.com";
	...
	*/
	...
	$config['messages']['delimiters']['status_prefix'] = '<div class="alert alert-info"><button type="button" class="close" data-dismiss="alert">&times;</button>';
	
	// Message End Delimiter
	$config['messages']['delimiters']['status_suffix'] = '</div>';
	
	// Error Start Delimiter
	$config['messages']['delimiters']['error_prefix'] = '<div class="alert alert-error"><button type="button" class="close" data-dismiss="alert">&times;</button>';
