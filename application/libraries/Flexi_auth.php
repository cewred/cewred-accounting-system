...
class Flexi_auth extends Flexi_auth_lite
{
	 ...
	 * @author Rob Hussey
	 */
	public function insert_user($email, $nip, $nip_bpk, $username = FALSE, $password, $user_data, $group_id = FALSE, $activate = FALSE) 
	{
		$user_id = $this->CI->flexi_auth_model->insert_user($email, $nip, $nip_bpk, $username, $password, $user_data, $group_id);
