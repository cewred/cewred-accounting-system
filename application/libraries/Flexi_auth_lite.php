...
class Flexi_auth_lite
{
	...
	/**
	 * get_user_first_name
	 * Get the users first name from the session.
	 *
	 * @return void
	 * @author Beni
	 */
	...
	{
		return ($this->CI->auth->session_data[$this->CI->auth->session_name['first_name']] !== FALSE) ? 
			$this->CI->auth->session_data[$this->CI->auth->session_name['first_name']] : FALSE;
	}
